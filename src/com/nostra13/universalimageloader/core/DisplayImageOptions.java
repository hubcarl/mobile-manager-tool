...
public final class DisplayImageOptions {
    ...
    public Bitmap getImageBitmapOnLoading(Resources res) {
        if (res.getDrawable(imageResOnLoading) instanceof BitmapDrawable) {
            return imageResOnLoading != 0 ? ((BitmapDrawable) res.getDrawable(imageResOnLoading)).getBitmap() : ((BitmapDrawable) imageOnLoading).getBitmap();
        } else {
            return null;
        }
    }
    ...
    public Bitmap getImageBitmapForEmptyUri(Resources res) {
        if (res.getDrawable(imageResForEmptyUri) instanceof BitmapDrawable) {
            return imageResForEmptyUri != 0 ? ((BitmapDrawable) res.getDrawable(imageResForEmptyUri)).getBitmap() : ((BitmapDrawable) imageForEmptyUri).getBitmap();
        } else {
            return null;
        }
    }
    ...
    public Bitmap getImageBitmapOnFail(Resources res) {
        if (res.getDrawable(imageResOnFail) instanceof BitmapDrawable) {
            return imageResOnFail != 0 ? ((BitmapDrawable) res.getDrawable(imageResOnFail)).getBitmap() : ((BitmapDrawable) imageOnFail).getBitmap();
        } else {
            return null;
        }
    }
	...
	public static class Builder {
		...
		private BitmapDisplayer displayer = com.nostra13.universalimageloader.core.DefaultConfigurationFactory.createBitmapDisplayer();
		...
		/**
		 * Sets custom {@linkplain android.os.Handler handlerName} for displaying images and firing {@linkplain com.nostra13.universalimageloader.core.listener.ImageLoadingListener
		 * listener} events.
		 */
		...
		public Builder cloneFrom(com.nostra13.universalimageloader.core.DisplayImageOptions options) {
