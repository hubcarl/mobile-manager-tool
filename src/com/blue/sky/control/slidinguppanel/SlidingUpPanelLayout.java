...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    /**
     * No-op stubs for {@link com.blue.sky.control.slidinguppanel.SlidingUpPanelLayout.PanelSlideListener}. If you only want to implement a subset
    ...
    public SlidingUpPanelLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (mShadowHeight > 0) {
            if (mIsSlidingUp) {
                mShadowDrawable = getResources().getDrawable(R.drawable.music_above_shadow);
            } else {
                mShadowDrawable = getResources().getDrawable(R.drawable.music_below_shadow);
            }
