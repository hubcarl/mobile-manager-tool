...
package com.blue.sky.control.download.providers.downloads;
...
public final class Downloads implements BaseColumns {
     ...
     */
    public static final String AUTHORITY = "com.blue.sky.mobile.manager";
     ...
     * @hide
     */
    public static final String PERMISSION_ACCESS = "com.blue.sky.permission.ACCESS_DOWNLOAD_MANAGER";
     ...
     * @hide
     */
    public static final String PERMISSION_ACCESS_ADVANCED = "com.blue.sky.permission.ACCESS_DOWNLOAD_MANAGER_ADVANCED";

    /**
     * The permission to access the all the downloads in the manager.
     */
    public static final String PERMISSION_ACCESS_ALL = "com.blue.sky.permission.ACCESS_ALL_DOWNLOADS";
     ...
     * @hide
     */
    public static final String PERMISSION_SEND_INTENTS = "com.blue.sky.permission.SEND_DOWNLOAD_COMPLETED_INTENTS";

    /**
     * The permission to download files without any system notification being
     * shown.
     */
    public static final String PERMISSION_NO_NOTIFICATION = "com.blue.sky.permission.DOWNLOAD_WITHOUT_NOTIFICATION";
