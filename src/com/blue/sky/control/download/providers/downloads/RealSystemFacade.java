...
class RealSystemFacade implements SystemFacade {
    ...
    // 2G、3G网络下 下载文件最大大小 20MB
    private static final long DOWNLOAD_MAX_BYTES_OVER_MOBILE = 20 * 1024 * 1024;
    // 10MB
    private static final long DOWNLOAD_RECOMMENDED_MAX_BYTES_OVER_MOBILE = 10 * 1024 * 1024;
