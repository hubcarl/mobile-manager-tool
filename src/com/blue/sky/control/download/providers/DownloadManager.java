...
package com.blue.sky.control.download.providers;
...
import com.blue.sky.control.download.providers.downloads.Downloads;
import com.blue.sky.control.download.util.LogUtil;
...
public class DownloadManager {
    ...
    public static class Request {
        ...
        private boolean isAddMediaScanner = false;
        ...
        public Request setAddMediaScanner() {
            isAddMediaScanner = true;
            return this;
        }
...
//		    subPath);
         ...
         * @return
         */
        public Request setDestinationInExternalDir(Context context, String dirType, String subPath) {

            String path = Environment.getExternalStorageDirectory().getAbsolutePath() + "/" + dirType + "/";
        ...
        private void setDestinationFromBase(File base, String subPath) {
            ...
            LogUtil.i(TAG, "mDestinationUri=" + mDestinationUri.toString());
        }
        ...
        ContentValues toContentValues(String packageName) {
            ...
            values.put("scanned", isAddMediaScanner);
