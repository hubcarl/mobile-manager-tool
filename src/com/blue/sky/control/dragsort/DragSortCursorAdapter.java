 ...
 * to {@link com.blue.sky.control.dragsort.DragSortListView#setAdapter(ListAdapter)} and, since
 * this class implements the {@link com.blue.sky.control.dragsort.DragSortListView.DragSortListener}
...
public abstract class DragSortCursorAdapter extends CursorAdapter implements DragSortListView.DragSortListener {
     ...
     *
     * @see com.blue.sky.control.dragsort.DragSortListView.DropListener#drop(int, int)
     */
    @Override
     ...
     * the current mapping with {@link getCursorPositions()}.
     *
     * @see com.blue.sky.control.dragsort.DragSortListView.RemoveListener#remove(int)
     */
    @Override
