...
import com.blue.sky.mobile.manager.music.module.local.NowPlayingCursor;
...
import com.blue.sky.mobile.manager.music.ui.adapters.QuickQueueAdapter;
...
public class QuickQueueFragment extends Fragment implements LoaderCallbacks<Cursor>,
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        // Adapter
        mQuickQueueAdapter = new QuickQueueAdapter(getActivity(), R.layout.music_quick_queue_items, null,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.music_quick_queue, container, false);
