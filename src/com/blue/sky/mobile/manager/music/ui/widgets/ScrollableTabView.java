...
import com.blue.sky.mobile.manager.music.ui.adapters.TabAdapter;
...
public class ScrollableTabView extends HorizontalScrollView implements
    ...
    private void initTabs() {
        ...
        LinearLayout.LayoutParams expandedTabLayoutParams = new LinearLayout.LayoutParams(0, LayoutParams.MATCH_PARENT, 1);
        for (int i = 0; i < mPager.getAdapter().getCount(); i++) {
            ...
            mContainer.addView(tab, i, expandedTabLayoutParams);
    ...
    private void selectTab(int position) {
        ...
        final int x = l - this.getWidth() /3 + w / 3;
