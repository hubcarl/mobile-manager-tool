...
package com.blue.sky.mobile.manager.music.app.widgets;
...
import com.blue.sky.mobile.manager.music.activities.MusicLibrary;
import com.blue.sky.mobile.manager.music.service.ApolloService;

import static com.blue.sky.mobile.manager.music.Constants.WIDGET_STYLE;
...
public class AppWidget41 extends AppWidgetProvider {
    ...
    private void defaultAppWidget(Context context, int[] appWidgetIds) {
    	...
    	final RemoteViews views = new RemoteViews(context.getPackageName(),
                (widget_type.equals(context.getResources().getString(R.string.widget_style_light))?R.layout.music_fourbyone_app_widget :R.layout.music_fourbyone_app_widget_dark));
    ...
    /**
     * Handle a change notification coming over from {@link com.blue.sky.mobile.manager.music.service.ApolloService}
     */
