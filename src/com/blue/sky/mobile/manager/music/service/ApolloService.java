...
import com.blue.sky.mobile.manager.music.app.widgets.AppWidget11;
import com.blue.sky.mobile.manager.music.app.widgets.AppWidget41;
import com.blue.sky.mobile.manager.music.app.widgets.AppWidget42;
import com.blue.sky.mobile.manager.music.cache.ImageInfo;
import com.blue.sky.mobile.manager.music.helpers.GetBitmapTask;
import com.blue.sky.mobile.manager.music.helpers.utils.ImageUtils;
import com.blue.sky.mobile.manager.music.helpers.utils.MusicUtils;
import com.blue.sky.mobile.manager.music.helpers.utils.VisualizerUtils;
import com.blue.sky.mobile.manager.music.preferences.SharedPreferencesCompat;
...
public class ApolloService extends Service implements GetBitmapTask.OnBitmapReadyListener {
    ...
    private void updateNotification() {
        ...
        status.icon = R.drawable.music_stat_notify_music;
        status.contentIntent = PendingIntent
                .getActivity(this, 0, new Intent("com.blue.sky.mobile.manager.PLAYBACK_VIEWER")
