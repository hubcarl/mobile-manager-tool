 ...
 * Original file: D:\\MyProject\\Android\\workspace\\MusicPlayer\\src\\com\\blue\\sky\\mobile\\manager\\music\\IApolloService.aidl
 */
package com.blue.sky.mobile.manager.music;

public interface IApolloService extends android.os.IInterface {
    /**
     * Local-side IPC implementation stub class.
     */
    public static abstract class Stub extends android.os.Binder implements com.blue.sky.mobile.manager.music.IApolloService {

        private static final int L = 1000;

        private static final java.lang.String DESCRIPTOR = "com.blue.sky.mobile.manager.music.IApolloService";
        ...
        /**
         * Cast an IBinder object into an com.blue.sky.mobile.manager.music.IApolloService interface,
         * generating a proxy if needed.
         */
        public static com.blue.sky.mobile.manager.music.IApolloService asInterface(android.os.IBinder obj) {
            if ((obj == null)) {
                return null;
            }
            android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (((iin != null) && (iin instanceof com.blue.sky.mobile.manager.music.IApolloService))) {
                return ((com.blue.sky.mobile.manager.music.IApolloService) iin);
            }
            return new com.blue.sky.mobile.manager.music.IApolloService.Stub.Proxy(obj);
        }
        ...
        private static class Proxy implements com.blue.sky.mobile.manager.music.IApolloService {
        ...
        static final int TRANSACTION_moveQueueItem = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
        ...
        static final int TRANSACTION_addToFavorites = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
        static final int TRANSACTION_removeFromFavorites = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
        static final int TRANSACTION_isFavorite = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
        static final int TRANSACTION_toggleFavorite = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
    }
