		...
		public boolean onDoubleTap(MotionEvent e) {
			...
			if (view instanceof QImageView) {
				...
				if (imageView.getScale() > imageView.getScaleRate()) {
					imageView.zoomTo(imageView.getScaleRate(), GalleryActivity.screenWidth / 2, GalleryActivity.screenHeight / 2, 200f);
					// imageView.layoutToCenter();
				} else {
					imageView.zoomTo(1.0f, GalleryActivity.screenWidth / 2, GalleryActivity.screenHeight / 2, 200f);
				}
			} else {
			}
			return true;
