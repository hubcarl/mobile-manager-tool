...
/**
 * 
 * 类名 SiteDetailActivity.java
 * 说明  
 * 作者  BlueSky
 * 版权  蓝天科技工作室
 * 创建时间  2014-11-02
 */
public class SiteDetailActivity extends BaseActivity implements OnScrollListener
{
    ...
    private void loadVideo(){
        ...
        new VideoHttpAsyncTask(new VideoCallbackResult() {
            ...
            public List<VideoInfo> request(String... params) {
                ...
                JSONObject result = Video.getHotVideo(SiteDetailActivity.this, categoryId + "", pageSize + "", pageIndex + "");
