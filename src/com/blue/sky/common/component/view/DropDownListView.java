package com.blue.sky.common.component.view;
 ...
 * before</li>
 * <li>{@link #setOnDropDownListener(com.blue.sky.common.component.view.DropDownListView.OnDropDownListener)} set listener which will be excuted when drop down, but you
