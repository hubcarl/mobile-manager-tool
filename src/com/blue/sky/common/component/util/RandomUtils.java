...
public class RandomUtils {
     ...
     * @param length
     * @return
     * @see com.blue.sky.common.component.util.RandomUtils#getRandom(String source, int length)
     */
     ...
     *         <li>else see {@link com.blue.sky.common.component.util.RandomUtils#getRandom(char[] sourceChar, int length)}</li>
     *         </ul>
     */
