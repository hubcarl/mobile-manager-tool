 ...
 * <li>{@link #httpGet(HttpRequest, com.blue.sky.common.component.util.HttpUtils.HttpListener)} http get asynchronous</li>
 * <li>{@link #httpGet(String, com.blue.sky.common.component.util.HttpUtils.HttpListener)} http get asynchronous</li>
 * </ul>
 * <ul>
...
public class HttpUtils {
     ...
     * @param httpUrl
     * @return the response of the url, if null represents http error
     * @see com.blue.sky.common.component.util.HttpUtils#httpGet(HttpRequest)
     */
     ...
     * @param httpUrl
     * @return the response of the url, if null represents http error
     * @see com.blue.sky.common.component.util.HttpUtils#httpPost(HttpRequest)
     */
     ...
     *        {@link com.blue.sky.common.component.util.HttpUtils#joinParas(java.util.Map)}
     * @return the content of the url, if null represents http error
     * @see com.blue.sky.common.component.util.HttpUtils#httpPost(HttpRequest)
     */
