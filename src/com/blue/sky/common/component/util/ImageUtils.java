...
public class ImageUtils {
     ...
     * @return
     * @see com.blue.sky.common.component.util.ImageUtils#getInputStreamFromUrl(String, int, boolean)
     */
     ...
     * @param readTimeOutMillis
     * @return
     * @see com.blue.sky.common.component.util.ImageUtils#getDrawableFromUrl(String, int, boolean)
     */
     ...
     * @param readTimeOut
     * @return
     * @see com.blue.sky.common.component.util.ImageUtils#getBitmapFromUrl(String, int, boolean)
     */
