...
import com.blue.sky.common.component.service.Cache;
import com.blue.sky.common.component.service.CacheFullRemoveType;
import com.blue.sky.common.component.util.MapUtils;
 ...
 * <li>{@link #saveCache(String, com.blue.sky.common.component.service.impl.SimpleCache)} save cache to file</li>
 * </ul>
 * <ul>
...
public class SimpleCache<K, V> implements Cache<K, V>, Serializable {
     ...
     * @see com.blue.sky.common.component.service.impl.SimpleCache#put(Object, CacheObject)
     */
    @Override
     ...
     * @param key
     * @return
     * @see com.blue.sky.common.component.service.impl.SimpleCache#isExpired(CacheObject)
     */
