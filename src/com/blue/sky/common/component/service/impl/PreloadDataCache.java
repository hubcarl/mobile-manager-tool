...
import com.blue.sky.common.component.util.ListUtils;
import com.blue.sky.common.component.util.ObjectUtils;
import com.blue.sky.common.component.util.SerializeUtils;
 ...
 * <li>{@link #setOnGetDataListener(com.blue.sky.common.component.service.impl.PreloadDataCache.OnGetDataListener)} set how to get data, this cache will get data and preload data
 * by it</li>
...
public class PreloadDataCache<K, V> extends SimpleCache<K, V> {
     ...
     * @see com.blue.sky.common.component.service.impl.PreloadDataCache#get(Object)
     */
     ...
     * <li>call {@link com.blue.sky.common.component.service.impl.PreloadDataCache.OnGetDataListener#onGetData(Object)} to get data and wait for it finish</li>
     * </ul>
     * 
     * @param key
     * @return element if this cache contains the specified key, else get data realtime and wait for it
